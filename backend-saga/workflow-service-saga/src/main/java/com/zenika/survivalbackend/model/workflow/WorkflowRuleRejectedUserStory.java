...
public class WorkflowRuleRejectedUserStory extends Event {
    private UUID userStoryId;
    private UUID projectId;
    private UserStoryStatus status;

    public WorkflowRuleRejectedUserStory(UUID id, UUID userStoryId, UUID projectId, UserStoryStatus status) {
        super(id);
